    ...
    <div class="col-md-8">
        ...
        <div class="col-md-9">
           <asp:TextBox ID="txtEmail" runat="server"></asp:TextBox>   
            ...
            <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" ControlToValidate="txtEmail" ErrorMessage="  الايميل مطلوب مثال :(ex@ex.com)" Font-Italic="True" ForeColor="Red" ValidationGroup="OK"></asp:RequiredFieldValidator>
